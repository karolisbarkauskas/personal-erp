    ...
    <tr>
        ...
        <td class="border-0 pl-0 text-center">
            ...
            <div class="vat-invoice-title">
                <strong>
                    {{ $invoice->name }} {{ __('invoices.client') }}: <br>
                    {{ $invoice->buyer->name }}
                </strong>
            </div>
        </td>
...
<table class="table">
    ...
    <tr>
        ...
        <th scope="col" class="text-center border-0">{{ __('invoices.quantity') }}(val.)</th>
    ...
    @foreach($invoice->items as $item)
        <tr>
            <td class="pl-0" style="width: 400px">{!! $item->title !!}</td>
    ...
    <tr>
        <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
        <td class="text-right pl-0 total_amount">{{ __('invoices.total') }}:</td>
