                            ...
                            <div class="card mg-t-10">
                                <div class="card-header d-sm-flex align-items-start justify-content-between">
                                    <div
                                        ...
                                        <br>
                                        Sale #{{ $sale->id }} for {{ $sale->project->name }}
                                        <br><br>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="wrapper" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr class="tx-10 tx-spacing-1 tx-color-03 tx-uppercase">
                                                ...
                                                <th class="text-center">Total expenses (time/other)</th>
                                                <th class="text-center">Sale status (based on budget)</th>
                                                <th class="text-center">Sale status (based on invoices)</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                ...
                                                <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 10px 0; text-align: center;">
                                                    {{ $sale->time_expenses }}€ / {{ $sale->getTotalExpended() }}€
                                                </td>
                                                <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 10px 0; text-align: center;">
                                                    {!! $sale->getSaleStatus() !!}
                                                </td>
                                                <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 10px 0; text-align: center;">
                                                    {!! $sale->getSaleStatusByInvoices() !!}
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
